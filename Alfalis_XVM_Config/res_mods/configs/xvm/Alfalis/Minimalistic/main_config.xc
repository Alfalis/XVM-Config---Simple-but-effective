...
//Release 27
{
	...
	"hangar":{
		...
		"carousel":{
			...
			"extraFields":[
				{"x": 130, "y": -1, "format": "<img src='cfg://Alfalis/Minimalistic/img/MoE_{{v.mastery}}.png' width='27' height='27'>"},
				//Winrate
	...
	"minimap":{
		...
		"minimapAimIcon": "cfg://Alfalis/Minimalistic/img/MinimapAim.png",
		"circles":{
			"view": [
	...
	"playersPanel":{
		...
		"large":{
			...
			"nickFormatRight": "<font alpha='#A0'>{{clan}}</font> {{name%.20s~..}}",
